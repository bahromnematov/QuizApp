...
public class PresenterImplEnglish implements TestScreenContract.Presenter {
    ...
    public PresenterImplEnglish(TestScreenContract.View view, TestScreenContract.Repository repository) {
        this.view = view;
