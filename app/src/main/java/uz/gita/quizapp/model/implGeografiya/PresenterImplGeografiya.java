...
public class PresenterImplGeografiya implements TestScreenContract.Presenter{
     ...
     public PresenterImplGeografiya(TestScreenContract.View view, TestScreenContract.Repository repository) {
         this.view = view;
