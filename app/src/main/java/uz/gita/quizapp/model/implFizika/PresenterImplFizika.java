...
public class PresenterImplFizika implements TestScreenContract.Presenter{
     ...
     public PresenterImplFizika(TestScreenContract.View view, TestScreenContract.Repository repository) {
         this.view = view;
